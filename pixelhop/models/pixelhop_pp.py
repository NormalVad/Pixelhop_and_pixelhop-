...
class PixelHopPP:
    def __init__(self, TH1=0.005, TH2=0.001, num_estimators=100):
        ...
        """
        # Create PixelHop units with C/W Saab transform
        # Parameters from Table 1: 5x5 neighborhood, stride=1, max-pooling for first two units only
        self.units = [
            PixelHopUnit(
        ...
        # XGBoost classifier with 100 estimators as per Table 1
